...
router.route("/login/user")             // route pour connexion "user"
        .post(controllerWrapper(authController.loginUser))

router.route("/login/association")      // route pour connexion "association"
...
router.route("/requests")
        ...
        .post(checkToken, controllerWrapper(requestController.create)); // controle token avant de créer une demande
